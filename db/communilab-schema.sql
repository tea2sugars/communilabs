...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores information about all defined bean types.' AUTO_INCREMENT=7 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores contents of custom-made blocks.' AUTO_INCREMENT=9 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores comments and associated data.' AUTO_INCREMENT=285 ;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores information on redirects.' AUTO_INCREMENT=1 ;
...
CREATE TABLE `views_view` (
  ...
  PRIMARY KEY (`vid`),
  UNIQUE KEY `name` (`name`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Stores the general data for a view.' AUTO_INCREMENT=4 ;
